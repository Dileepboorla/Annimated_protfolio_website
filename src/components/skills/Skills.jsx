...
import { IoLogoJavascript, IoLogoPython } from "react-icons/io/index.esm";
          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<IoLogoPython/>} name={"python"} value={88} />
                <ProgressBar
                  logo={<IoLogoHtml5/>}
                  name={"Javascript"}
                  value={80}
                />
                <ProgressBar logo={<IoLogoJavascript/>} name={"React Js"} value={80} />
                <ProgressBar
                  logo={<SiTailwindcss />}
                  name={"Tailwind CSS"}
                  value={60}
